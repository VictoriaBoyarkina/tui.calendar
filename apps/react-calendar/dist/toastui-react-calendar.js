...
(function(global2, factory) {
  ...
  var n$2, l$3, u$3, i$4, o$3, r$2, f$3, e$1, c$3, s$3, a$3, h$3 = {}, p$3 = [], v$3 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, y$3 = Array.isArray;
  function d$3(n2, l2) {
    for (var u2 in l2)
      n2[u2] = l2[u2];
    return n2;
  ...
  function x$4(n2, l2) {
    if (null == l2)
      return n2.__ ? x$4(n2.__, n2.__i + 1) : null;
    for (var u2; l2 < n2.__k.length; l2++)
      if (null != (u2 = n2.__k[l2]) && null != u2.__e)
        return u2.__e;
    return "function" == typeof n2.type ? x$4(n2) : null;
  }
  function C$3(n2) {
    var l2, u2;
  ...
  function M$2(n2) {
    (!n2.__d && (n2.__d = true) && i$4.push(n2) && !P$2.__r++ || o$3 !== l$3.debounceRendering) && ((o$3 = l$3.debounceRendering) || r$2)(P$2);
  }
  function P$2() {
    var n2, u2, t2, o2, r2, e2, c2, s2;
    for (i$4.sort(f$3); n2 = i$4.shift(); )
      n2.__d && (u2 = i$4.length, o2 = void 0, e2 = (r2 = (t2 = n2).__v).__e, c2 = [], s2 = [], t2.__P && ((o2 = d$3({}, r2)).__v = r2.__v + 1, l$3.vnode && l$3.vnode(o2), O$3(t2.__P, o2, r2, t2.__n, t2.__P.namespaceURI, 32 & r2.__u ? [e2] : null, c2, null == e2 ? x$4(r2) : e2, !!(32 & r2.__u), s2), o2.__v = r2.__v, o2.__.__k[o2.__i] = o2, j$4(c2, o2, s2), o2.__e != e2 && C$3(o2)), i$4.length > u2 && i$4.sort(f$3));
    P$2.__r = 0;
  }
  function S$2(n2, l2, u2, t2, i2, o2, r2, f2, e2, c2, s2) {
    var a2, v2, y2, d2, w2, _2 = t2 && t2.__k || p$3, g2 = l2.length;
    for (u2.__d = e2, $$1(u2, l2, _2), e2 = u2.__d, a2 = 0; a2 < g2; a2++)
      null != (y2 = u2.__k[a2]) && "boolean" != typeof y2 && "function" != typeof y2 && (v2 = -1 === y2.__i ? h$3 : _2[y2.__i] || h$3, y2.__i = a2, O$3(n2, y2, v2, i2, o2, r2, f2, e2, c2, s2), d2 = y2.__e, y2.ref && v2.ref != y2.ref && (v2.ref && N$1(v2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), 65536 & y2.__u || v2.__k === y2.__k ? e2 = I$1(y2, e2, n2) : "function" == typeof y2.type && void 0 !== y2.__d ? e2 = y2.__d : d2 && (e2 = d2.nextSibling), y2.__d = void 0, y2.__u &= -196609);
    u2.__d = e2, u2.__e = w2;
  }
  function $$1(n2, l2, u2) {
    var t2, i2, o2, r2, f2, e2 = l2.length, c2 = u2.length, s2 = c2, a2 = 0;
    for (n2.__k = [], t2 = 0; t2 < e2; t2++)
      r2 = t2 + a2, null != (i2 = n2.__k[t2] = null == (i2 = l2[t2]) || "boolean" == typeof i2 || "function" == typeof i2 ? null : "string" == typeof i2 || "number" == typeof i2 || "bigint" == typeof i2 || i2.constructor == String ? g$3(null, i2, null, null, null) : y$3(i2) ? g$3(k$4, { children: i2 }, null, null, null) : void 0 === i2.constructor && i2.__b > 0 ? g$3(i2.type, i2.props, i2.key, i2.ref ? i2.ref : null, i2.__v) : i2) ? (i2.__ = n2, i2.__b = n2.__b + 1, f2 = L$2(i2, u2, r2, s2), i2.__i = f2, o2 = null, -1 !== f2 && (s2--, (o2 = u2[f2]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f2 && a2--, "function" != typeof i2.type && (i2.__u |= 65536)) : f2 !== r2 && (f2 == r2 - 1 ? a2-- : f2 == r2 + 1 ? a2++ : f2 > r2 ? s2 > e2 - r2 ? a2 += f2 - r2 : a2-- : f2 < r2 && (f2 == r2 - a2 ? a2 -= f2 - r2 : a2++), f2 !== t2 + a2 && (i2.__u |= 65536))) : (o2 = u2[r2]) && null == o2.key && o2.__e && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = x$4(o2)), V$1(o2, o2, false), u2[r2] = null, s2--);
    if (s2)
      for (t2 = 0; t2 < c2; t2++)
        null != (o2 = u2[t2]) && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = x$4(o2)), V$1(o2, o2));
  }
  function I$1(n2, l2, u2) {
    ...
    n2.__e != l2 && (l2 && n2.type && !u2.contains(l2) && (l2 = x$4(n2)), u2.insertBefore(n2.__e, l2 || null), l2 = n2.__e);
    do {
  ...
  function H$2(n2, l2) {
    return l2 = l2 || [], null == n2 || "boolean" == typeof n2 || (y$3(n2) ? n2.some(function(n3) {
      H$2(n3, l2);
    }) : l2.push(n2)), l2;
  }
  ...
  function A$4(n2, l2, u2, t2, i2) {
    ...
    n:
      if ("style" === l2)
        ...
        o2 = l2 !== (l2 = l2.replace(/(PointerCapture)$|Capture$/i, "$1")), l2 = l2.toLowerCase() in n2 || "onFocusOut" === l2 || "onFocusIn" === l2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + o2] = u2, u2 ? t2 ? u2.u = t2.u : (u2.u = e$1, n2.addEventListener(l2, o2 ? s$3 : c$3, o2)) : n2.removeEventListener(l2, o2 ? s$3 : c$3, o2);
      else {
  ...
  function O$3(n2, u2, t2, i2, o2, r2, f2, e2, c2, s2) {
    ...
    n:
      if ("function" == typeof T2)
        try {
          ...
          h2.state = h2.__s, null != h2.getChildContext && (i2 = d$3(d$3({}, i2), h2.getChildContext())), x2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, w2)), S$2(n2, y$3(L2 = null != a2 && a2.type === k$4 && null == a2.key ? a2.props.children : a2) ? L2 : [L2], u2, t2, i2, o2, r2, f2, e2, c2, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && f2.push(h2), g2 && (h2.__E = h2.__ = null);
        } catch (n3) {
        ...
        null == r2 && u2.__v === t2.__v ? (u2.__k = t2.__k, u2.__e = t2.__e) : u2.__e = z$3(t2.__e, u2, t2, i2, o2, r2, f2, c2, s2);
    (a2 = l$3.diffed) && a2(u2);
  }
  ...
  function z$3(l2, u2, t2, i2, o2, r2, f2, e2, c2) {
    ...
    if (null === b2)
      ...
      if (r2 = r2 && n$2.call(l2.childNodes), m2 = t2.props || h$3, !e2 && null != r2)
      ...
      for (s2 in m2)
        if (d2 = m2[s2], "children" == s2)
          ...
          if ("value" == s2 && "defaultValue" in k2 || "checked" == s2 && "defaultChecked" in k2)
            continue;
          A$4(l2, s2, null, d2, o2);
        }
      for (s2 in k2)
        d2 = k2[s2], "children" == s2 ? v2 = d2 : "dangerouslySetInnerHTML" == s2 ? a2 = d2 : "value" == s2 ? _2 = d2 : "checked" == s2 ? g2 = d2 : "key" === s2 || e2 && "function" != typeof d2 || m2[s2] === d2 || A$4(l2, s2, d2, m2[s2], o2);
      if (a2)
        e2 || p2 && (a2.__html === p2.__html || a2.__html === l2.innerHTML) || (l2.innerHTML = a2.__html), u2.__k = [];
      else if (p2 && (l2.innerHTML = ""), S$2(l2, y$3(v2) ? v2 : [v2], u2, t2, i2, "foreignObject" === b2 ? "http://www.w3.org/1999/xhtml" : o2, r2, f2, r2 ? r2[0] : t2.__k && x$4(t2, 0), e2, c2), null != r2)
        for (s2 = r2.length; s2--; )
          null != r2[s2] && w$4(r2[s2]);
      e2 || (s2 = "value", void 0 !== _2 && (_2 !== l2[s2] || "progress" === b2 && !_2 || "option" === b2 && _2 !== m2[s2]) && A$4(l2, s2, _2, m2[s2], o2), s2 = "checked", void 0 !== g2 && g2 !== l2[s2] && A$4(l2, s2, g2, m2[s2], o2));
    }
    return l2;
  }
  ...
  function V$1(n2, u2, t2) {
    ...
    t2 || null == n2.__e || w$4(n2.__e), n2.__c = n2.__ = n2.__e = n2.__d = void 0;
  }
  ...
  function B$3(u2, t2, i2) {
    var o2, r2, f2, e2;
    l$3.__ && l$3.__(u2, t2), r2 = (o2 = "function" == typeof i2) ? null : i2 && i2.__k || t2.__k, f2 = [], e2 = [], O$3(t2, u2 = (!o2 && i2 || t2).__k = _$3(k$4, null, [u2]), r2 || h$3, h$3, t2.namespaceURI, !o2 && i2 ? [i2] : r2 ? null : t2.firstChild ? n$2.call(t2.childNodes) : null, f2, !o2 && i2 ? i2 : r2 ? r2.__e : t2.firstChild, o2, e2), j$4(f2, u2, e2);
  }
  function E$2(l2, u2, t2) {
    var i2, o2, r2, f2, e2 = d$3({}, l2.props);
    ...
    return arguments.length > 2 && (e2.children = arguments.length > 3 ? n$2.call(arguments, 2) : t2), g$3(l2.type, e2, i2 || l2.key, o2 || l2.ref, null);
  }
  function G$1(n2, l2) {
    var u2 = { __c: l2 = "__cC" + a$3++, __: n2, Consumer: function(n3, l3) {
  ...
  n$2 = p$3.slice, l$3 = { __e: function(n2, l2, u2, t2) {
    ...
    var u2;
    u2 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = d$3({}, this.state), "function" == typeof n2 && (n2 = n2(d$3({}, u2), this.props)), n2 && d$3(u2, n2), null != n2 && this.__v && (l2 && this._sb.push(l2), M$2(this));
  }, b$2.prototype.forceUpdate = function(n2) {
    this.__v && (this.__e = true, n2 && this.__h.push(n2), M$2(this));
  }, b$2.prototype.render = k$4, i$4 = [], r$2 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$3 = function(n2, l2) {
    return n2.__v.__b - l2.__v.__b;
  }, P$2.__r = 0, e$1 = 0, c$3 = F$1(false), s$3 = F$1(true), a$3 = 0;
  var t$1, r$1, u$2, i$3, o$2 = 0, f$2 = [], c$2 = l$3, e = c$2.__b, a$2 = c$2.__r, v$2 = c$2.diffed, l$2 = c$2.__c, m$1 = c$2.unmount, s$2 = c$2.__;
  function d$2(n2, t2) {
  ...
  function y$2(n2, u2) {
    var i2 = d$2(t$1++, 3);
    !c$2.__s && C$2(i2.__H, u2) && (i2.__ = n2, i2.i = u2, r$1.__H.__h.push(i2));
  }
  function _$2(n2, u2) {
    var i2 = d$2(t$1++, 4);
    !c$2.__s && C$2(i2.__H, u2) && (i2.__ = n2, i2.i = u2, r$1.__h.push(i2));
  }
  function A$3(n2) {
  ...
  c$2.__b = function(n2) {
    ...
    v$2 && v$2(n2);
    var t2 = n2.__c;
    t2 && t2.__H && (t2.__H.__h.length && (1 !== f$2.push(t2) && i$3 === c$2.requestAnimationFrame || ((i$3 = c$2.requestAnimationFrame) || w$3)(j$3)), t2.__H.__.forEach(function(n3) {
  ...
  function w$3(n2) {
    var t2, r2 = function() {
      clearTimeout(u2), k$3 && cancelAnimationFrame(t2), setTimeout(n2);
    }, u2 = setTimeout(r2, 100);
    k$3 && (t2 = requestAnimationFrame(r2));
  }
  function z$2(n2) {
  ...
  function d$1(n2, e2) {
    return void 0 === e2 && (e2 = false), y$1(n2) || r(n2) || !t(n2) || (o$1(n2) > 1 && (n2.set = n2.add = n2.clear = n2.delete = h$1), Object.freeze(n2), e2 && i$2(n2, function(n3, r2) {
      return d$1(r2, true);
    }, true)), n2;
  }
  function h$1() {
  ...
  function g$2(n2) {
    O$2(n2), n2.p.forEach(S$1), n2.p = null;
  }
  function O$2(n2) {
    n2 === U$1 && (U$1 = n2.l);
  }
  ...
  function P$1(r2, e2) {
    ...
    return e2.h.O || b$1("ES5").S(e2, r2, o2), o2 ? (i2[Q$1].P && (g$2(e2), n$1(4)), t(r2) && (r2 = M$1(e2, r2), e2.l || x$2(e2, r2)), e2.u && b$1("Patches").M(i2[Q$1].t, r2, e2.u, e2.s)) : r2 = M$1(e2, i2, []), g$2(e2), e2.u && e2.v(e2.u, e2.s), r2 !== H$1 ? r2 : void 0;
  }
  function M$1(n2, r2, t2) {
    ...
    if (!e2.I) {
      ...
      3 === e2.i && (u2 = new Set(o2), o2.clear(), a2 = true), i$2(u2, function(r3, i2) {
  ...
  var G, U$1, W$1 = "undefined" != typeof Symbol && "symbol" == typeof Symbol("x"), X$1 = "undefined" != typeof Map, q$3 = "undefined" != typeof Set, B$1 = "undefined" != typeof Proxy && void 0 !== Proxy.revocable && "undefined" != typeof Reflect, H$1 = W$1 ? Symbol.for("immer-nothing") : ((G = {})["immer-nothing"] = true, G), L$1 = W$1 ? Symbol.for("immer-draftable") : "__$immer_draftable", Q$1 = W$1 ? Symbol.for("immer-state") : "__$immer_state", Z$1 = "" + Object.prototype.constructor, nn = "undefined" != typeof Reflect && Reflect.ownKeys ? Reflect.ownKeys : void 0 !== Object.getOwnPropertySymbols ? function(n2) {
    ...
    return void 0 !== z$1(n2.t, r2) || r2 in n2.t ? (n2.R[r2] = false, E$1(n2), k$2(n2)) : delete n2.R[r2], n2.o && delete n2.o[r2], true;
  ...
  const templates = {
    milestone(model) {
      ...
      return /* @__PURE__ */ _$3(k$4, null, /* @__PURE__ */ _$3("span", {
  ...
  function createStoreContext() {
    ...
    const useStore2 = (selector, equalityFn = Object.is) => {
      const storeCtx = x$3(StoreContext);
      if (isNil(storeCtx)) {
        throw new Error("StoreProvider is not found");
      }
      const [, notify] = p$2((notifyCount) => notifyCount + 1, 0);
  ...
  const EventBusContext = G$1(
    null
  );
  const EventBusProvider = EventBusContext.Provider;
  const useEventBus = () => {
    const eventBus = x$3(EventBusContext);
    if (!eventBus) {
  ...
  const getDayGridEventModels = (eventModels2, row, narrowWeekend = false) => {
    forEachMatrix3d(eventModels2, (uiModel) => {
      const modelStart = uiModel.getStarts();
      const modelEnd = uiModel.getEnds();
      const { width, left } = getEventLeftAndWidth(modelStart, modelEnd, row, narrowWeekend);
      uiModel.width = width;
  ...
  const getWeekViewEvents = (row, calendarData, {
    ...
    const eventModels2 = findByDateRange(calendarData, {
      start: weekStartDate,
      end: weekEndDate,
      panels,
      andFilters: [],
    ...
    return Object.keys(eventModels2).reduce(
      (acc, cur) => {
        const events = eventModels2[cur];
        return __spreadProps(__spreadValues({}, acc), {
  ...
  (C$1.prototype = new b$2()).isPureReactComponent = true, C$1.prototype.shouldComponentUpdate = function(n2, t2) {
  ...
  var w$1 = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.forward_ref") || 3911;
  function k$1(n2) {
    function t2(t3) {
      var e2 = g$1({}, t3);
      return delete e2.ref, n2(e2, t3.ref || null);
    }
    return t2.$$typeof = w$1, t2.render = t2, t2.prototype.isReactComponent = t2.__f = true, t2.displayName = "ForwardRef(" + (n2.displayName || n2.name) + ")", t2;
  }
  var M = l$3.__e;
  ...
  l$3.unmount = function(n2) {
  ...
  }, (L.prototype = new b$2()).__c = function(n2, t2) {
    var e2 = t2.__c, r2 = this;
    null == r2.t && (r2.t = []), r2.t.push(e2);
    var u2 = O$1(r2.__v), o2 = false, i2 = function() {
    ...
    if (this.__b) {
      if (this.__v.__k) {
        ...
        this.__v.__k[0] = A$1(this.__b, r2, o2.__O = o2.__P);
      }
      this.__b = null;
    }
    var i2 = e2.__a && _$3(k$4, null, n2.fallback);
    return i2 && (i2.__u &= -33), [_$3(k$4, null, e2.__a ? null : n2.children), i2];
  };
  ...
  function P(n2) {
    ...
    } }), B$3(_$3(W, { context: e2.context }, n2.__v), e2.l);
  }
  function j$1(n2, e2) {
    var r2 = _$3(P, { __v: n2, i: e2 });
    return r2.containerInfo = e2, r2;
  }
  (U.prototype = new b$2()).__a = function(n2) {
    var t2 = this, e2 = O$1(t2.__v), r2 = t2.o.get(n2);
  ...
  function GridCell$1({
    ...
    const { borderRight, backgroundColor } = useTheme(q$1((theme) => theme.week.dayGrid, []));
    const style = {
      width,
      left,
  ...
  const GridCells = x$1(function GridCells2({
    ...
    return /* @__PURE__ */ _$3(k$4, null, weekDates.map((cell, index) => {
  ...
  function useCurrentPointerPositionInGrid(gridPositionFinder) {
    ...
    const clearCurrentGridPos = q$1(() => setCurrentGridPos(null), []);
  ...
  function useGridRowHeightController(maxTop, category) {
    ...
    const onClickCollapseButton = q$1(() => {
  ...
  function useGridSelection({
    ...
    useTransientUpdate(
      q$1((state) => state.gridSelection[type], [type]),
      (gridSelection) => {
  ...
  function AlldayGridRow({
    ...
    return /* @__PURE__ */ _$3(k$4, null, /* @__PURE__ */ _$3("div", {
  ...
  const FloatingLayerContext = G$1(null);
  ...
  const useFloatingLayer = (floatingLayerType) => {
    var _a;
    const floatingLayers = x$3(FloatingLayerContext);
  ...
  function useFormState(initCalendarId) {
    return p$2(formStateReducer, __spreadValues({ calendarId: initCalendarId }, defaultFormState));
  }
  const classNames$f = {
  ...
  function PanelResizer({ name, height }) {
    const border = useTheme(q$1((theme) => theme.week.panelResizer.border, []));
  ...
  function GridSelection({ top, height, text }) {
    const { backgroundColor, border } = useTheme(
      q$1((theme) => theme.common.gridSelection, [])
    );
    const color = useTheme(q$1((theme) => theme.week.gridSelection.color, []));
    const style = {
      top: toPercent(top),
    ...
    }, text.length > 0 ? /* @__PURE__ */ _$3("span", {
  ...
  const Column = x$1(function Column2({
    ...
    const borderRight = useTheme(q$1((theme) => theme.week.timeGrid.borderRight, []));
  ...
  function NowIndicatorLabel({ unit, top, now, zonedNow }) {
    const color = useTheme(q$1((theme) => theme.week.nowIndicatorLabel.color, []));
  ...
  function useIsMounted() {
    ...
    return q$1(() => isMountedRef.current, []);
  }
  const classNames = {
  ...
  function TimeGrid({ timeGridData, events }) {
    ...
    const updateTimeGridIndicator = q$1(() => {
  ...
  function Day$1() {
    ...
    const primaryTimezoneName = useStore(primaryTimezoneSelector);
    const gridHeaderMarginLeft = useTheme(q$1((theme) => theme.week.dayGridLeft.width, []));
  ...
  const GridRow = x$1(function GridRow2({
    ...
    const [container, containerRefCallback] = useDOMNode();
    const border = useTheme(q$1((theme) => theme.common.border, []));
    return /* @__PURE__ */ _$3("div", {
  ...
  var n$3 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i, o = /^(area|base|br|col|embed|hr|img|input|link|meta|param|source|track|wbr)$/, i = /[\s\n\\/='"\0<>]/, l = /^xlink:?./, a = /["&<]/;
  function s(e2) {
    if (false === a.test(e2 += ""))
      return e2;
  ...
  function p$4(e2) {
    ...
    for (var r2 in e2) {
      var o2 = e2[r2];
      null != o2 && "" !== o2 && (t2 && (t2 += " "), t2 += "-" == r2[0] ? r2 : c[r2] || (c[r2] = r2.replace(_, "-$1").toLowerCase()), t2 = "number" == typeof o2 && false === n$3.test(r2) ? t2 + ": " + o2 + "px;" : t2 + ": " + o2 + ";");
    }
    return t2 || void 0;
  }
  function d(e2, t2) {
  ...
  var y = [];
  function m$2(r2, n2, a2, c2, _2, v2) {
    ...
    if ("function" == typeof C2) {
      if (j2 = true, !a2.shallow || !c2 && false !== a2.renderRootComponent) {
        if (C2 === k$4) {
          var A2 = [];
          return d(A2, r2.props.children), m$2(A2, n2, a2, false !== a2.shallowHighOrder, _2, v2);
        }
        var F2, H2 = r2.__c = h$4(r2, n2);
        l$3.__b && l$3.__b(r2);
        var M2 = l$3.__r;
        if (C2.prototype && "function" == typeof C2.prototype.render) {
          ...
          for (var T2 = g$4(C2, n2), E2 = 0; H2.__d && E2++ < 25; )
            H2.__d = false, M2 && M2(r2), F2 = C2.call(r2.__c, O2, T2);
        return H2.getChildContext && (n2 = Object.assign({}, n2, H2.getChildContext())), l$3.diffed && l$3.diffed(r2), m$2(F2, n2, a2, false !== a2.shallowHighOrder, _2, v2);
      }
      ...
      for (var W2 = 0; W2 < P2.length; W2++) {
        ...
        if ("children" !== I2) {
          if (!i.test(I2) && (a2 && a2.allAttributes || "key" !== I2 && "ref" !== I2 && "__self" !== I2 && "__source" !== I2)) {
            ...
            "style" === I2 && R2 && "object" == typeof R2 && (R2 = p$4(R2)), "a" === I2[0] && "r" === I2[1] && "boolean" == typeof R2 && (R2 = String(R2));
    ...
    if (D2)
      ...
      for (var B2 = b2 && ~N2.indexOf("\n"), G2 = false, J2 = 0; J2 < q2.length; J2++) {
        var K2 = q2[J2];
        if (null != K2 && false !== K2) {
          var Q2 = m$2(K2, n2, a2, true, "svg" === C2 || "foreignObject" !== C2 && _2, v2);
  ...
  function S(n2, o2, i2) {
    ...
    var l2 = l$3.__s;
    l$3.__s = true;
    var a2, s2 = _$3(k$4, null);
    return s2.__k = [n2], a2 = i2 && (i2.pretty || i2.voidElements || i2.sortAttributes || i2.shallow || i2.allAttributes || i2.xml || i2.attributeHook) ? m$2(n2, o2, i2) : F(n2, o2, false, void 0, s2), l$3.__c && l$3.__c(n2, k), l$3.__s = l2, k.length = 0, a2;
  }
  function w(e2) {
  ...
  function O(e2, t2) {
    return "style" === e2 && null != t2 && "object" == typeof t2 ? p$4(t2) : "a" === e2[0] && "r" === e2[1] && "boolean" == typeof t2 ? String(t2) : t2;
  }
    ...
    if ("function" == typeof _2) {
      ...
      if (_2 === k$4)
        ...
        d2 = _2.prototype && "function" == typeof _2.prototype.render ? function(e2, r3) {
          var n3 = e2.type, o2 = g$4(n3, r3), i2 = new n3(e2.props, o2);
          ...
          var n3, o2 = h$4(e2, r3), i2 = g$4(e2.type, r3);
          e2.__c = o2;
      ...
      var y2 = F(d2 = null != d2 && d2.type === k$4 && null == d2.key ? d2.props.children : d2, n2, l2, a2, r2);
