...
const calendarId = esm_browser_v4();
...
/* harmony default export */ var constants_initialEvents = (eventModels);
...
function createStoreContext() {
  ...
  const useStore = function (selector) {
    ...
    const [, notify] = hooks_module_p(notifyCount => notifyCount + 1, 0);
...
function useFormState(initCalendarId) {
  return hooks_module_p(formStateReducer, {
